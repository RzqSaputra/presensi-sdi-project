                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="jam_masuk" id="jam_masuk" class="form-control" 
                                                required value="{{$detail->mulai}}" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="jam_pulang" id="jam_pulang" class="form-control"
                                                required value="{{$detail->selesai}}" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="text-start">
