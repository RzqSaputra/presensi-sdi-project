...
<body class="g-sidenav-show bg-gray-100">
                ...
                <div class="p-5 bg-white rounded-3">
                    <div class="d-flex justify-content-center">
                        <h5 class="font-weight-bolder me-3 bag">
                            ...
                            <form method="POST" action="{{ route('presensiPM.masuk')}}" enctype="multipart/form-data">
                                @csrf
                            ...
                            Presensi Pulang
                            <form method="POST" action="{{ route('presensiPM.pulang', $presensi->id)}}" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="lokasi" value="" id="lokasi">
                                <input type="hidden" name="my_camera" class="image-tag">
                                <div class="text-center">
    ...
    <script>
        ...
        if (filename === 'presensiPM' || filename === 'sakit' || filename === 'izin') {
